            ...
            <div class="c-fi-wrapper">
                <div class="c-fi-grid">
                    <div class="c-fi-cell hero">
                        <a class="c-fi-link ga-event" data-event-action="Feature Hero Image Click" href="/ika/user/profile.php" style="background-image:url(/sdi1400301/img/bookcase.jpg)">
                    ...
                    <div class="c-fi-cell">
                        <div class="c-fi-grid nested">
                            <div class="c-fi-cell">
                                <a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/ika/pension/pension.php/" style="background-image:url(/sdi1400301/img/report.jpg)">
                                    <div class="c-fi-text">Αναφορά Διανομών</div>
                                </a>
                            </div>
                            <div class="c-fi-cell">
                                <a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/ika/work/business.php/" style="background-image:url(/sdi1400301/img/store_front.jpg)">
