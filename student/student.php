        	...
        	<div class="c-fi-wrapper">
            	<div class="c-fi-grid">
                	<div class="c-fi-cell hero">
                    	<a class="c-fi-link ga-event" data-event-action="Feature Hero Image Click" href="/ika/user/profile.php" style="background-image:url(/Eudoxus/img/filling_application.jpg)">
                	...
                	<div class="c-fi-cell">
                    	<div class="c-fi-grid nested">
                        	<div class="c-fi-cell">
                            	<a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/ika/pension/pension.php/" style="background-image:url(/Eudoxus/img/book_swap.jpg)">
                                	<div class="c-fi-text">Ανταλλαγή Συγγραμμάτων</div>
                            	</a>
                        	</div>
                        	<div class="c-fi-cell">
                            	<a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="/ika/work/business.php/" style="background-image:url(/Eudoxus/img/books_cover.jpg)">
                                	<div class="c-fi-text">Διαθέσιμα Συγγράμματα</div>
                            	</a>
                        	</div>
                        	<div class="c-fi-cell">
                            	<a class="c-fi-link ga-event" data-event-action="Feature Image Click" href="#" style="background-image:url(/Eudoxus/img/history.jpg)">
